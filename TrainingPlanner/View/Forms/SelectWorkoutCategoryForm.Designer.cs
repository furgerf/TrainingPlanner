...
{
  partial class SelectWorkoutCategoryForm
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.lisCategories.KeyDown += new System.Windows.Forms.KeyEventHandler(this.lisCategories_KeyDown);
      this.lisCategories.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.lisCategories_MouseDoubleClick);
      // 
      // SelectWorkoutCategoryForm
      // 
      ...
      this.Name = "SelectWorkoutCategoryForm";
      this.Text = "Select Workout Category";
